...
const BottomNav = ({ activeTab, onTabChange, onCreatePost, onSpinWheel, pendingCount = 0 }: BottomNavProps) => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-t border-border pb-safe bottom-nav will-change-transform transform-gpu isolate">
